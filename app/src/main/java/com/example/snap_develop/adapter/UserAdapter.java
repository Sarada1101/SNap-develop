...
public class UserAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.post = convertView.findViewById(R.id.listPostTextView);
            holder.photo = convertView.findViewById(R.id.listPhotoImageView);
            ...
            holder.datetime = convertView.findViewById(R.id.listDateTextView);
